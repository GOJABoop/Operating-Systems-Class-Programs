#ifndef ADMINISTRA_PROCESO_H_INCLUDED
#define ADMINISTRA_PROCESO_H_INCLUDED
#include <queue>
#include <vector>
#include <cmath>
#include <ctime>
...
private:
    ...
    int getTamanioProceso(){
        return rand() % (25-6+1) +6;
    }
public:
    AdministraProcesos(){
        procesosNuevos = 0;
    ...
    void agregaProceso(){
        ...
        p->setTamanio(getTamanioProceso());
        procesos.push(p);
        procesosNuevos++;
        contadorId++;
    }
...
#endif // ADMINISTRA_PROCESO_H_INCLUDED
